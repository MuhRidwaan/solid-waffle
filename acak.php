...
<body>
    ...
    <div class="container">
        <div style="text-align: center; padding: 20px"><b><?php echo $acara; ?></b><img style="margin-top: -10px"
                height="50px" src="gambar/<?php echo $logo; ?>"></div>
        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                <div class="form-group">
                    <textarea type="text" name="kalimat" id="kalimat"
                        placeholder="Isikan kalimat yang akan diacak, pisahkan dengan Enter"
                        class="form-control"></textarea>
                </div>
                <div class="col-xs-6">
                    <div class="form-group">
                        <button id="resetkalimat" class="btn btn-block btn-lg btn-danger">Reset</button>
                    </div>
                </div>
                <div class="col-xs-6" id="tombolacakkalimat">
                    <div class="form-group">
                        <button id="acakkalimat" class="btn btn-block btn-lg btn-primary">Acak</button>
                    </div>
                </div>
                <div class="col-xs-6" id="tombolstopkalimat">
                    <div class="form-group">
                        <button id="stopkalimat" class="btn btn-block btn-lg btn-warning">Stop</button>
                    </div>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="form-group">
                    <textarea type="text" style="height: 150px" name="hasilkalimat" id="hasilkalimat"
                        placeholder="Hasil acak kalimat" class="form-control"></textarea>
                </div>
            </div>
            <div class="col-xs-12">
                <h3>Acak Angka</h3>
            ...
            <div class="col-xs-6">
                <div class="form-group">
                    <input type="number" name="angkaawal" id="angkaawal"
                        placeholder="Isikan angka awal yang akan diacak" class="form-control">
                    <input type="number" name="angkaakhir" id="angkaakhir"
                        placeholder="Isikan angka akhir yang akan diacak" style="margin-top: 10px" class="form-control">
                </div>
                <div class="col-xs-6">
                    <div class="form-group">
                        <button id="resetangka" class="btn btn-block btn-lg btn-danger">Reset</button>
                    </div>
                </div>
                <div class="col-xs-6">
                    <div class="form-group" id="tombolacakangka">
                        <button id="acakangka" class="btn btn-block btn-lg btn-primary">Acak</button>
                    </div>
                </div>
                <div class="col-xs-6" id="tombolstopangka">
                    <div class="form-group">
                        <button id="stopangka" class="btn btn-block btn-lg btn-warning">Stop</button>
                    </div>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="form-group">
                    <textarea type="text" style="height: 150px" name="hasilangka" id="hasilangka"
                        placeholder="Hasil acak angka" class="form-control"></textarea>
                </div>
            </div>
        </div> <!-- /.col-xs-3 -->
    </div> <!-- /.row -->
        ...
        document.getElementById("acakkalimat").addEventListener('click', function() {
            ...
            if (res.length == 0) {
                document.getElementById("hasilkalimat").value =
                    "Semua kalimat telah teracak, silahkan reset untuk mengacak ulang";
            } else {
        ...
        document.getElementById("acakangka").addEventListener('click', function() {
            ...
            if (!isReallyNumber(x) || !isReallyNumber(y)) {
                ...
                document.getElementById("hasilangka").value =
                    "Pastikan angka awal lebih kecil dari pada angka akhir!";
                cek2 = 0;
            } else {
                if (cek2 == 0) {
                    angka = [];
                ...
                if (angka.length == 0) {
                    document.getElementById("hasilangka").value =
                        "Semua angka telah teracak, silahkan reset untuk mengacak ulang";
                } else {
